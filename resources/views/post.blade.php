...
<header>
        <div class="container">
                ...
                <ul class="main-menu font-mountainsre" id="main-menu">
                    @foreach($post as $key => $help)
                        <li><a href="posts/cat/{{$key}}">{{ $help['author']}}</a></li>
                    @endforeach
                ...
                <div class="row">
                        ...
                        <div class="col-md-6">
                                <div class="sided-90x mb-30 ">
                                        ...
                                        <div class="s-right">
                                                <h5 class="mb-10"><b><a href="posts/{id}/{product_id}">Pizza Margherita</a></b><b class="color-primary float-right">$12.00</b></h5>
