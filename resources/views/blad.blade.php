...
<section class="bg-4 h-500x main-slider pos-relative">
        ...
        <div class="container h-100">
                <div class="dplay-tbl">
                        <div class="dplay-tbl-cell center-text color-white pt-90">
                                ...
                                <h2 class="mt-30 mb-15">{{$post['name']}}</h2>
                        </div><!-- dplay-tbl-cell -->
                </div><!-- dplay-tbl -->
        </div><!-- container -->
</section>
    <section class="bg-lite-blue">
        <div class="container">
                <div class="row">
                        @foreach($post['products'] as $product_id => $basa)
                        <div class="col-md-6">
                                <div class="sided-90x mb-30 ">
                                        <div class="s-left"><img class="br-3" src="images/menu-1-120x120.jpg" alt="Menu Image"></div><!--s-left-->
                                        <div class="s-right">
                                                <h5 class="mb-10"><b><a href="/public/posts/cat/{{$id}}/{{$product_id}}">{{$basa['name']}}</a></b><b class="color-primary float-right">{{$basa['cost']}}</b></h5>
...
<section class="story-area left-text center-sm-text">
        <div class="container">
                ...
                <div class="row">
                        ...
                        <div class="col-md-12">
                                <div class="mt-50 mt-sm-30 mb-50 mb-sm-30 center-text"> <h2>{{dd($post)}}</h2> </div>
